...
const ratingLabels = ["Not useful", "Slightly", "Useful", "Very useful", "Excellent"];
...
export function ReportFeedback({
  ...
  if (status === "sent") {
    return (
      <div
        className="card-shadow max-w-[720px] rounded-2xl p-8 text-center backdrop-blur-sm sm:p-10"
        style={{
          border: "1px solid color-mix(in srgb, var(--primary) 25%, transparent)",
          background:
            "linear-gradient(135deg, color-mix(in srgb, var(--primary) 8%, transparent) 0%, var(--surface-transparent) 100%)",
        }}
      >
        <div
        ...
        <p className="mt-2 text-sm" style={{ color: "var(--text-muted)" }}>
          We&apos;ll factor this into next week&apos;s report.
        </p>
      </div>
    );
  }
  ...
  return (
    <form
      ...
      className="card-shadow max-w-[720px] rounded-2xl p-6 backdrop-blur-sm sm:p-8"
      style={{
        border: "1px solid color-mix(in srgb, var(--primary) 20%, transparent)",
        background:
          "linear-gradient(135deg, color-mix(in srgb, var(--primary) 6%, transparent) 0%, var(--surface-transparent) 100%)",
      }}
    >
      <h3
      ...
      <div className="mb-6">
        <label
          ...
          style={{ color: "var(--text-body)" }}
        >
          How many leads did you close this week from our funnel?
        </label>
        <input
          type="number"
          min="0"
          ...
          placeholder="0"
          className="w-full max-w-[200px] rounded-lg px-3 py-2.5 text-sm outline-none transition focus:ring-2"
          style={{
            border: "1px solid var(--border)",
      ...
      <div className="mb-6">
        <label
          ...
          style={{ color: "var(--text-body)" }}
        >
          Estimated value of leads closed this week?
          <span
        ...
        <div className="relative w-full max-w-[200px]">
          ...
          <input
            ...
            placeholder="0.00"
            className="w-full rounded-lg py-2.5 pl-7 pr-3 text-sm outline-none transition focus:ring-2"
            style={{
              border: "1px solid var(--border)",
              backgroundColor: "var(--surface-transparent)",
              color: "var(--text-heading)",
      ...
      <div className="mb-6">
        ...
        <textarea
          ...
          rows={3}
          className="w-full resize-none rounded-lg px-3 py-2.5 text-sm outline-none transition focus:ring-2"
          style={{
            border: "1px solid var(--border)",
            backgroundColor: "var(--surface-transparent)",
            color: "var(--text-heading)",
